...
Die Platine ist für die Versorgung mit +24V ausgelegt und  in erster Linie zur Verwendung mit der [TW39-Platine ohne FSG](../Ohne-FSG/TW39-ohne-FSG-mit-Powersave/) gedacht. Bei anderen Versorgungsspannungen sind die Widerstände R1 und R5 so anzupassen, dass der TWB einen Strom von ca 10-20mA "zieht", dabei ist die nötige Belastbarkeit der Widerstände berücksichtigen.
...
Pin 2 des J1 kann entweder auf GND des piTelex-Boards gelegt werden oder aber bei Verwendung der [TW39-Platine ohne FSG](../Ohne-FSG/TW39-ohne-FSG-mit-Powersave) an die Kathode der LED_WB. Dann wird die gesamte Schaltung nur im Status "Wählbereit" mit Spannung versorgt.
